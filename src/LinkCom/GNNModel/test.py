...
def parameter_parser():
    parser = argparse.ArgumentParser(description="Run SimGNN Based Model.")
    ...
    parser.add_argument("--load-path",
                        type=str,
                        # default='D:\\Projects\\Result\\results_gcn3\\epoch_7.pt',
                        default=None,
...
tab_printer(args)
device = args.device
# args.score-path = "D:\\Projects\\Lucia\\link_testing_data.csv"
